          ...
          <motion.div variants={controlItem}>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                >
                  A to Z
                  {sortOption === "az" && <Check className="h-4 w-4" />}
                </DropdownMenuItem>
                <DropdownMenuItem 
                ...
                >
                  Z to A
                  {sortOption === "za" && <Check className="h-4 w-4" />}
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </motion.div>
              ...
              {selectedStatus && (
                <Badge 
                  ...
                  className={`flex items-center gap-1.5 ${
                    selectedStatus === 'Completed' ? 'bg-green-500/20 text-green-600 dark:text-green-400' :
                    selectedStatus === 'In Progress' ? 'bg-blue-500/20 text-blue-600 dark:text-blue-400' :
                    selectedStatus === 'Maintaining' ? 'bg-purple-500/20 text-purple-600 dark:text-purple-400' :
                    ''
                  }`}
                >
